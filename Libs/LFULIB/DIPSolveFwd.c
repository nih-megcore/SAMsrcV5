// DIPSolveFwd() - solve for constrained & unconstrained forward solutions
//  plus unconstrained moment vector using multisphere or sphere model
//
...
void DIPSolveFwd(
    ...
    ChannelInfo *Channel,   // sensor information (with sphere origins)
    ...
    DIPLeadField(Voxel->p, L, Header, Channel, 3);      // solve with 3rd-order integration
