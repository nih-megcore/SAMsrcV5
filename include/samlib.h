...
double  Dflip(void *);
double  SensorNM(FIELD *Sensor, FIELD *Dipole, gsl_matrix *Xm, gsl_matrix *Xv, double *current, int Sindex);
double  DipoleNM(FIELD *Sensor, FIELD *Dipole, gsl_matrix *Xm, gsl_matrix *Xv, double *Current, int Dindex);
...
float   Fflip(void *);
void    FIELDtoA6(FIELD *parms, double *a6);
void    A6toFIELD(double *a6, FIELD *parms);
void    FIELD2Vector(FIELD *parms, gsl_vector *a);
void    OPMFIELD2Vector(OPMFIELD *parms, gsl_vector *a);
...
double  FitOPM_plus(int S, gsl_matrix *Xm, gsl_matrix *Xnoise, double *Moment, OPMFIELD *Sensor, FIELD *Dipole, double param_min[6], double param_max[6]);
...
void    gsl_matrix_plus_equal(gsl_matrix *, int, int, double);
void    gsl_vector_plus_equal(gsl_vector *, int, double);
void    gsl_vector_norm(gsl_vector *a);
double  gsl_vector_norm2(gsl_vector *a);
double  gsl_vector_gain(gsl_vector *a);
...
double  MagFitSensor(FIELD *Sensor, FIELD *Dipole, gsl_matrix *Measured, gsl_matrix *Variance, int S);
double  MagFitDipole(FIELD *Dipole, FIELD *Sensor, gsl_matrix *Measured, gsl_matrix *Variance, int D);
...
double  MSolveSensor(FIELD *Sensor, FIELD *Dipole, gsl_matrix * Measured, gsl_matrix *Variance, int S);
...
double  OPMCoeff_plus(int S, gsl_matrix *Xm,  gsl_matrix *Xnoise, double *Moment, FIELD *Dipole, gsl_vector *a, gsl_matrix *alpha, gsl_vector *beta);
...
void    Vector2OPMFIELD(gsl_vector *a, OPMFIELD *parms);
