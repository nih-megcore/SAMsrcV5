/* ==========================================================================
 * $Header: MRI_Headers.h,v 1.1 99/07/19 10:27:31 dougc Exp $
 * ==========================================================================
 *
 * Author's comments
 *
 ...
 *
 * $Log:	MRI_Headers.h,v $
 * Revision 1.1  99/07/19  10:27:31  10:27:31  dougc (Doug)
 * Initial revision
 * 
 *
 * ==========================================================================
 */
#ifndef	_MRI_HEADERS_H
#define _MRI_HEADERS_H

// **********************************
// 	derived from CTF_MRI_Headers.h
// **********************************

///////////////////////////////////////////////
// note that the following relationship is used in 
// coordinate transformations in MRIViewer 
//  sagittal = x
//	coronal = y
// 	axial = z
//
